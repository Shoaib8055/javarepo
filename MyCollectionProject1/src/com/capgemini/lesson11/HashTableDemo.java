...
class HashTableDemo {
	public static void main(String args[]) {
		// Create a hash map
		Hashtable<String, Double> balance = new Hashtable<String, Double>();  // thread safe and all methods are synchronized
		Enumeration names;
		String str;
		double bal;
		...
		///balance.put(null, 4454.78); // runtime exception NullPointerException
